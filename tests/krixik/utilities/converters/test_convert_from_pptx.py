from krixik.utilities.converters.pptx_to_txt import (
    convert,
)
...
valid_local_file_path = text_files_path + "a sample slide.pptx"
...
test_delete_data = [text_files_path + "Pride and Eights.pptx"]
