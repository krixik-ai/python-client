from krixik.utilities.validators.data.pptx import is_valid
from krixik.utilities.validators.data.pptx import is_size
...
test_success_data = [text_files_path + "a sample slide.pptx"]
