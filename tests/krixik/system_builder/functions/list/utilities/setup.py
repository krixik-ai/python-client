...
from tests.krixik.system_builder.functions.list.utilities.test_data import test_data
from tests.krixik.system_builder.functions.list.utilities.test_data import wait_for_test_data
...
def load_pipeline():
    ...
    # reset the pipeline name so it is uniqe to this function
    pipeline.pipeline_name = f"{pipeline.pipeline}-list"
